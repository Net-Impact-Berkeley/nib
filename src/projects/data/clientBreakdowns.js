        ...
        projects: [
            {
                ...
                ourWork: "Phase 1: Research Foundation Conducted literature reviews and case studies on teen leadership development and existing youth programs. Undertook internal interviews with Best Buy Foundation staff to understand the landscape. Established a robust foundation for the Teen Leadership Council program. \n Phase 2: Strategy Development. Crafted a comprehensive council program for the Teen Tech Center initiative. Considered key factors such as structure, adult-youth dynamics, incentives, and benefits. Created four user personas to guide strategy and explore various scenarios",
                impact: "We presented our deliverables to over 30 Best Buy Foundation executives and employees, creating a holistic project that balanced the company's needs with benefits for youth through research and strategy. The client expressed enthusiasm for the presented information and ideas, anticipating the implementation of our council suggestions as the Teen Tech Center program expands nationwide.",
            },
            {
                projectName: "Salesforce",
                projectLogo: require("../img/clients/salesforce.png"),
                aboutClient: "Salesforce is a cloud-based customer relationship management (CRM) platform that provides businesses with a suite of tools and applications for managing sales, customer service, marketing, and more. It helps organizations streamline and automate their processes to enhance customer relationships and improve overall efficiency.",
        ...
        projects: [
            {
                ...
                impact: "We delivered 3 reimagined LUNAFEST roadmaps that we presented in-person to the heads of the program and Clif Bar's brand director. We also created a written deliverable that specifically answered over 30 target questions from the LUNAFEST team."
            },
            {
                projectName: "SCE",
            ...
            },
            {
                ...
                ourWork: "The client wanted us to create a Digital Readiness Toolkit to help them evaluate the digital readiness of smallholder farmers across the world. They wanted us to create an evaluation system to determine if smallholder farmers were ready to step forward into the digital world.",
        ...
        projects: [
            {
                ...
                ourWork: "Client wanted us to ideate a plan to make nutrition better for cancer patients, initially proposed something like a meal kit service. Phase 1 involved looking at case studies of different meal kits that existed, detailing pros and cons. We also created what an LLS nutrition app should look like. In Phase 2, the instruction was to go broad, looking at partnership opportunities between LLS, cancer care centers, and insurance.",
                impact: "We helped LLS identify additional areas where they could play into the oncology nutrition space",
                links: [
                    {
                        text: "Fast Company",
                        link: "https://www.fastcompany.com/90919082/new-ideas-to-help-cancer-patients"
                    }
                ]
            },
            {
